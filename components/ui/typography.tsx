...
const AnimatedBlockQuote = Animated.createAnimatedComponent(BlockQuote);
const AnimatedCode = Animated.createAnimatedComponent(Code);
const AnimatedH1 = Animated.createAnimatedComponent(H1);
const AnimatedH2 = Animated.createAnimatedComponent(H2);
const AnimatedH3 = Animated.createAnimatedComponent(H3);
const AnimatedH4 = Animated.createAnimatedComponent(H4);
const AnimatedLarge = Animated.createAnimatedComponent(Large);
const AnimatedLead = Animated.createAnimatedComponent(Lead);
const AnimatedMuted = Animated.createAnimatedComponent(Muted);
const AnimatedP = Animated.createAnimatedComponent(P);
const AnimatedSmall = Animated.createAnimatedComponent(Small);
